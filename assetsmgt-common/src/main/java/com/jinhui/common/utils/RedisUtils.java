...
public class RedisUtils {
    ...
    public static SysUserEntity getLocalUser() {
        return fromJson(RedisUtils.threadLocal.get(), SysUserEntity.class);
    }

    public static SysUserEntity getRedisUser(HttpServletRequest req) {
        return RedisUtils.get(req.getHeader("token"), SysUserEntity.class, RedisUtils.ONE_HOUR_EXPIRE);
    }
