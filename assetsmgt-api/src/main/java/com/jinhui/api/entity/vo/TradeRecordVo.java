...
public class TradeRecordVo {
    ...
    public static TradeRecordVo toTradeRecordVo(Trade trade) {
        ...
        vo.setUserName(trade.getUserName());
        vo.setUserId(trade.getUserId());
        vo.setOperateUserName(trade.getOperateUserName());
        return vo;
    ...
    public static TradeRecordVo toTradeRecordVo(RegularTrade regularTrade) {
        ...
        vo.setUserId(regularTrade.getUserId());
        vo.setUserName(regularTrade.getUserName());
        vo.setOperateUserName(regularTrade.getOperateUserName());
        return vo;
    }
